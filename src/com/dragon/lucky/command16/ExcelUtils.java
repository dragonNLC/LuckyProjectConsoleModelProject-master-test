...
import com.dragon.lucky.command16.GenerateBean;
import com.dragon.lucky.command16.NumberBean;
import com.dragon.lucky.command16.NumberDataBean;
import com.dragon.lucky.command16.OnceGenerateBean;
                ...
                for (int j = 0; j < generateData.size(); j++) {
                    ...
                    for (int k = 0; k < content.size(); k++) {
                        for (int l = 0; l < content.get(k).getData().length; l++) {
                            if (!collect.containsKey(String.valueOf(content.get(k).getData()[l]))) {
                                collect.put(String.valueOf(content.get(k).getData()[l]), 0);
                            }
                            collect.put(String.valueOf(content.get(k).getData()[l]), collect.get(String.valueOf(content.get(k).getData()[l])) + 1);
                        }
                    }
                        ...
                        for (int l = 0; l < singleContent.getData().length; l++) {
                            ...
                            if (singleContent.getDataHitIdx()[l] == 1) {
                                if (singleContent.getDeprecatedDataIdx()[l] == 1) {
                                    ...
                                    if (collect.get(String.valueOf(content.get(k).getData()[l])) > 1) {
