...
import com.dragon.lucky.fpa.bean.DMBean;
import com.dragon.lucky.fpa.bean.PreviewDataBean;
import com.dragon.lucky.fpa.bean.PrintDataBean;
import com.dragon.lucky.fpa.bean.SMBean;
        ...
        try {
            ...
            for (int i = 4; i < itemElements.size(); i++) {
                ...
                if (i == 4) {//最新的
                    ...
                    /*previewSingleData.sort(new Comparator<PreviewDataBean.PreviewSingleDataBean>() {
                        @Override
                    ...
                    /*previewSingleData2.sort(new Comparator<PreviewDataBean.PreviewSingleDataBean>() {
                        @Override
                        public int compare(PreviewDataBean.PreviewSingleDataBean o1, PreviewDataBean.PreviewSingleDataBean o2) {
                            return Integer.compare(o1.data, o2.data);
                        }
                    ...
                    for (int j = 7; j < tdElements.size() - 1; j++) {
                        Element element = tdElements.get(j).firstElementChild();
                        boolean isTrue = element.hasClass("nub-purple");
                        String html = element.html();
...
//                    Log.i("本期出数：" + redNumber.html());
    ...
    /**
     * https://expert.78500.cn/dlt/lqsdm/
     * 后区三胆
     */
    public static SMBean doConnect10() {
//        Log.i("正在解析网页...");
        String url = "https://expert.78500.cn/dlt/lqsdm/";
        Map<String, String> map = new HashMap<>();
        map.put("issue", "100");
...
//                    Log.i("本期出数：" + blueNumber.html());
    ...
    /**
     * https://expert.78500.cn/dlt/lqssm/
     * 后区杀三码
     */
    public static SMBean doConnect11() {
//        Log.i("正在解析网页...");
        String url = "https://expert.78500.cn/dlt/lqssm/";
        Map<String, String> map = new HashMap<>();
        map.put("issue", "100");
...
//                    Log.i("本期出数：" + blueNumber.html());
    ...
    /**
     * https://www.cjcp.cn/zoushitu/cjwdlt/qqfenqu-03-2-100.html
     * 前区走势
     */
    public static List<Integer> doConnect12() {
//        Log.i("正在解析网页...");
        String url = "https://www.cjcp.cn/zoushitu/cjwdlt/qqfenqu-03-2-100.html";
        Map<String, String> map = new HashMap<>();
        map.put("issue", "100");
...
//        }
    ...
    /**
     * https://www.cjcp.cn/zoushitu/cjwdlt/hqzonghe-2-100.html
     * 后区走势
     */
    public static List<Integer> doConnect13() {
//        Log.i("正在解析网页...");
        String url = "https://www.cjcp.cn/zoushitu/cjwdlt/hqzonghe-2-100.html";
        Map<String, String> map = new HashMap<>();
        map.put("issue", "100");
...
//        }
    ...
    /**
     * https://zst.cjcp.cn/cjwdlt/view/dltjiben_content.html
     * 开奖历史走势
     */
    public static List<PrintDataBean> doConnect14(String endQi) throws IOException {
        String url = "https://zst.cjcp.cn/cjwdlt/view/dltjiben_content.html";
        Map<String, String> map = new HashMap<>();
        ...
        if (urlConnection.getResponseCode() == 200) {
            ...
            FileReadHelper.writeToFile("C:\\Users\\aptdev\\Desktop\\za\\20231030\\out.html", is);
            Log.i("读取成功！");
        }
        urlConnection.disconnect();

        try {
            Document document = Jsoup.parse(new File("C:\\Users\\aptdev\\Desktop\\za\\20231030\\out.html"));
