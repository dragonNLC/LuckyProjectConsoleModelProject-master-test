...
import com.dragon.lucky.fpaSsq.bean.*;
...
public class Printer4History100 {
...
//                            Log.i("data5.dataItem.size()   " + data5.dataItem.size() );
//                            Log.i("j " + j );
...
//                    Log.i(key + "-" + x2.get(key));
            ...
            for (int i = 0; i < 12; i++) {
                ...
                result.yellowResult.add(new TwoPoint(data2.dataItem.get(data2.dataItem.size() - 2 - i).blueData[0], 0/*data2.dataItem.get(data2.dataItem.size() - 2 - i).blueData[1]*/));
...
//                Log.i("allPrint.get(i).getBlueBalls() = " + Arrays.toString(allPrint.get(i).getBlueBalls()));
            ...
            for (int i = start; i < filterPrintData.size(); i++) {
                ...
                result.oriResult.add(new TwoPoint(filterPrintData.get(i).getBlueBalls()[0], /*filterPrintData.get(i).getBlueBalls()[1]*/0));
