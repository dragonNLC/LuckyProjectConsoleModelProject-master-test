...
//                writableSheet.setRowView(line, 600);
                ...
                writableSheet.setColumnView(columeIdx + 1, 3);//设置单元格宽度
                labelX = new Label(columeIdx + 1, line, onceGenerateBean.getTitle(), writableCellFormat);
                writableSheet.addCell(labelX);

                writableSheet.setColumnView(columeIdx + 2, 3);//设置单元格宽度
                labelX = new Label(columeIdx + 2, line, "文件总数", writableCellFormat);
                writableSheet.addCell(labelX);
                writableSheet.setColumnView(columeIdx + 3, 3);//设置单元格宽度
                ...
                columeIdx = 0;
                writableSheet.setColumnView(columeIdx, 3);//设置单元格宽度
                labelX = new Label(columeIdx, line, onceGenerateBean.getFqSize() + "位分区", writableCellFormat);
                writableSheet.addCell(labelX);
                columeIdx++;
                for (String key :
