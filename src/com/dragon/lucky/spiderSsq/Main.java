...
import com.dragon.lucky.spider.bean.FrequencyBean;
import com.dragon.lucky.spider.bean.NumberBean;
import com.dragon.lucky.spider.bean.SubItemBean;
import com.dragon.lucky.spider.utils.CacheUtils;
import com.dragon.lucky.spider.utils.JsoupHelper;
import com.dragon.lucky.spider.utils.Log;
...
public class Main {
    ...
    public static final String WZ1_CACHE_PATH = "C:\\Users\\aptdev\\Desktop\\za\\20231013-2\\wz1.txt";
    public static final String WZ2_CACHE_PATH = "C:\\Users\\aptdev\\Desktop\\za\\20231013-2\\wz2.txt";
    public static String PRINT_CACHE_PATH = "C:\\Users\\aptdev\\Desktop\\za\\20231011-2\\结果+.xlsx";
    public static final String STATISTICS_NAME = "统计";


    public static void main(String[] args) {
        List<DateDataBean> result = JsoupHelper.doConnect();
        List<DateDataBean> result2 = JsoupHelper.doConnect2();

        ////////////////////////拿到两个网站的数据，开始保存到本地////////////////////////
        List<DateDataBean> wz1Data = CacheUtils.readCache(WZ1_CACHE_PATH);
        wz1Data = CacheUtils.mergeContent(result, wz1Data);
        CacheUtils.cacheW(WZ1_CACHE_PATH, wz1Data);

        List<DateDataBean> wz2Data = CacheUtils.readCache(WZ2_CACHE_PATH);
        wz2Data = CacheUtils.mergeContent(result2, wz2Data);
        CacheUtils.cacheW(WZ2_CACHE_PATH, wz2Data);
