...
public class ContainThread extends Thread {
    ...
    public ContainThread(GenerateRunner runner, List<ResultMergeBean> content1, int start, int end, List<ResultMergeBean> content2, int start2, int end2) {
        this.mRunner = runner;
...
//        Log.i("content2 = " + content2.size());
        List<ResultBean> result = new ArrayList<>(FilterUtils.getContains2(getName(), content1, start, end, content2, start2, end2));
        /*try {
